...
class theClient:
	...
	def __init__(self,connectionType):
		try:
			...
			self.connection = pika.BlockingConnection(pika.ConnectionParameters('localhost',5672,'deployvhost',creds,heartbeat=0,socket_timeout=None))
